              ...
              <ul class="participants-list" style="list-style-type: none; padding-left: 0;">
                ${details.participants.map(email => `
                  <li style="display: flex; align-items: center; margin-bottom: 2px;">
                    ...
                    <span class="delete-participant" data-activity="${name}" data-email="${email}" title="Remove participant" style="cursor:pointer; color:#c62828; margin-left:8px; font-size:18px;">&#128465;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
